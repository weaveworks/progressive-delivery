...
var file_api_prog_prog_proto_rawDesc = []byte{
	...
	0x61, 0x75, 0x74, 0x6f, 0x6d, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0x8c, 0x02, 0x0a, 0x1a, 0x50,
	...
	0x65, 0x73, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x42, 0x30, 0x5a, 0x2e, 0x67, 0x69, 0x74,
...
var file_api_prog_prog_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_api_prog_prog_proto_goTypes = []interface{}{
	...
	(*Canary)(nil),               // 7: Canary
	(*ListError)(nil),            // 8: ListError
	(*Automation)(nil),           // 9: Automation
}
var file_api_prog_prog_proto_depIdxs = []int32{
	6, // 0: ListCanariesRequest.pagination:type_name -> Pagination
	7, // 1: ListCanariesResponse.canaries:type_name -> Canary
	8, // 2: ListCanariesResponse.errors:type_name -> ListError
	7, // 3: GetCanaryResponse.canary:type_name -> Canary
	9, // 4: GetCanaryResponse.automation:type_name -> Automation
	0, // 5: ProgressiveDeliveryService.GetVersion:input_type -> GetVersionRequest
	2, // 6: ProgressiveDeliveryService.ListCanaries:input_type -> ListCanariesRequest
	4, // 7: ProgressiveDeliveryService.GetCanary:input_type -> GetCanaryRequest
	1, // 8: ProgressiveDeliveryService.GetVersion:output_type -> GetVersionResponse
	3, // 9: ProgressiveDeliveryService.ListCanaries:output_type -> ListCanariesResponse
	5, // 10: ProgressiveDeliveryService.GetCanary:output_type -> GetCanaryResponse
